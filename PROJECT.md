...
- ⏳ 9 remaining — ALL need pricing research (none pre-staged now). Priority order: iphone-15-plus, iphone-se-3, samsung-galaxy-s24, samsung-galaxy-s23-ultra, samsung-galaxy-s23, samsung-galaxy-a54, samsung-galaxy-z-fold-5, samsung-galaxy-z-flip-5 (foldables — search carefully, very different repair economics), pixel-8.
  - Apple guide count is now **9** on brands.html. iphone-15-plus would make it 10. samsung pages go in brands/samsung.html (count currently "1 guide live"); pixel-8 in brands/google.html ("1 guide live").
